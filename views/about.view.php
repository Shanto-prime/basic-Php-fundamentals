...
<body class="h-full">
    <div class="min-h-full">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <a href="/" aria-current="page" class="rounded-md px-3 text-gray-300 py-2 text-sm font-medium">Home</a>
                                <a href="/about.php" class="rounded-md px-3 py-2 text-sm font-medium bg-gray-900 text-white hover:bg-white/5 hover:text-white">About</a>
        ...
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <p>Hello! This is the template from tailwind</p>
                <p>You're in the About page</p>
            </div>
        </main>
    </div>
